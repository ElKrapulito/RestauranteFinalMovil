...
import com.moviles.restaurante.fragments.RestaurantsFragment.OnListFragmentInteractionListener
 ...
 */
class MyRestaurantsRecyclerViewAdapter(
    private val mValues: List<Restaurant>,
    private val mListener: OnListFragmentInteractionListener?
) : RecyclerView.Adapter<MyRestaurantsRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mImg: ImageView = mView.imgRestaurant
    }
}
